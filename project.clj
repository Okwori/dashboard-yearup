(defproject yearup "0.1.0-SNAPSHOT"
  ...
  :description "YearUp DashBoard"
  :url "https://dashboard-yearup.herokuapp.com/"
  ...
  :dependencies [[ch.qos.logback/logback-classic "1.2.3"]
                 ...
                 ;[cljsjs/datatables.net-select-bs "1.2.5-0"]
                 ;[cljsjs/datatables.net-responsive "2.2.1-0"]
                 ;[cljsjs/datatables.net-responsive-bs "2.2.1-0"]
                 ;[cljsjs/datatables.net-keytable-bs "2.3.2-0"]
                 ;[cljsjs/datatables.net-col-reorder-bs "1.4.1-0"]
                 ;[cljsjs/datatables.net-buttons-bs "1.5.1-0"]
